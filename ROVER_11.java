...
public class ROVER_11 extends LinkedList{
	...
	//for A* search computation(walker)
	float startcost,goalcost;

	public ROVER_11() {
		// constructor
		System.out.println("ROVER_11 rover object constructed");
		rovername = "ROVER_11";
		//to connect with the local server
	...
	private void run() throws IOException, InterruptedException {
	 ...
	 //Building up logic for A* search
	 //A* works like the Breadth-First Search
	 //we need to declare 2 functions; one for finding the path to the neighboring node and one to the goal node
     public float getNeighbourCost(float neighbourcost) {
		return neighbourcost; 
     }
     public float getgoalCost() {
		return goalcost;
     }
	 public List NeighbourList(){
		return null;
	 }
     @SuppressWarnings("unchecked")
	 public void addto(Comparable object) {
     ...
     //We have to construct a path from the start position of the bot to the goal position
     //Here's how we can find a path from start node to the end node if there exists one
     /**Here**/
